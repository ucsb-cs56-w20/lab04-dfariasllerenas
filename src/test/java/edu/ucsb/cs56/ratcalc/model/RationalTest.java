/** A class to test a rational number
  with a numerator and denominator
  @author David Farias-Llerenas, Ethan Scott
*/
...
@Test
    ...
    public void test_recip_25_20()
    {
        ...
        assertEquals("4/5", temp.toString());
    }


    @Test
    public void test_recip_25_100()
    {
        Rational r = new Rational(25,100);
        Rational temp = r.reciprocalOf();
        assertEquals("4", temp.toString());
    }


    @Test
    public void test_recip_m20_25()
    {
        Rational r = new Rational(-20,25);
        Rational temp = r.reciprocalOf();
        assertEquals("-5/4", temp.toString());
    }

    @Test
    public void test_dividedBy_1_4_and_1_4()
    {
        Rational r = new Rational(1,4);
        Rational s = new Rational(1,4);
        Rational temp = r.dividedBy(s);
        assertEquals("1", temp.toString());
    }

    @Test
    public void test_dividedBy_1_4_and_4_1()
    {
        Rational r = new Rational(1,4);
        Rational s = new Rational(4,1);
        Rational temp = r.dividedBy(s);
        assertEquals("1/16", temp.toString());
    }

    @Test
    public void test_dividedBy_2_5_and_4_3()
    {
        Rational r = new Rational(2,5);
        Rational s = new Rational(4,3);
        Rational temp = r.dividedBy(s);
        assertEquals("3/10", temp.toString());
    }

    @Test
    public void test_quotient_2_5_and_4_3()
    {
        Rational r = new Rational(2,5);
	Rational x = new Rational(4,3);
	Rational temp = Rational.quotient(r,x);
	assertEquals("3/10", temp.toString());
    }

    @Test
    public void test_quotient_1_4_and_4_1()
    {
	Rational r = new Rational(1,4);
    ...
    @Test
    public void test_quotient_m1_4_and_1_4()
    {
	Rational r = new Rational(-1,4);
